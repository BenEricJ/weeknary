  ...
  try {
    const response = await fetch("https://api.openai.com/v1/responses", {
      ...
      body: JSON.stringify({
        model,
        instructions:
          "Create an editable German wellness planning draft. Do not provide medical advice. Return practical meals, workouts, and week structure only. Keep every date inside the requested range. Use empty strings for absent times.",
